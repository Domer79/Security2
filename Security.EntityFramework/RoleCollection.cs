...
{
    public class RoleCollection : IRoleCollection, IDisposable
    {
        ...
        {
            return _context.Roles.Any(e => e.Name == item.Name);
        }
        ...
        {
            return _context.Roles.Remove((Role) item) != null;
        }
        ...
        /// </returns>
        public Expression Expression => ((IQueryable<Role>) _context.Roles).Expression;
        ...
        /// </returns>
        public Type ElementType => ((IQueryable<Role>) _context.Roles).ElementType;
        ...
        /// </returns>
        public IQueryProvider Provider => ((IQueryable<Role>) _context.Roles).Provider;
